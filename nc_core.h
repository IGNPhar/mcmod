...
#define NC_FIELDS(X) \
  ...
  X(fps_alpha, F, 1.0, 0.05, 1) X(fps_bg_alpha, F, 0.75, 0.0, 1) X(fps_bg, I, 1, 0, 1) X(fps_menus, I, 1, 0, 1) \
  X(armor_on,     I, 1,    0, 1) X(armor_x, F, 0.005, 0, 1) X(armor_y, F, 0.03, 0, 1) X(armor_size, F, 3.0, 1.0, 8.0) \
  X(armor_alpha, F, 1.0, 0.05, 1) X(armor_bg_alpha, F, 0.75, 0.0, 1) X(armor_bg, I, 0, 0, 1) X(armor_bar, I, 0, 0, 1) X(armor_num, I, 1, 0, 2) \
  ...
  X(arrow_alpha, F, 1.0, 0.05, 1) X(arrow_bg_alpha, F, 0.75, 0.0, 1) X(arrow_col, I, 0xEBEBF5, 0, 0xFFFFFF) X(arrow_bg, I, 1, 0, 1) \
  X(speed_on,     I, 0,    0, 1) X(speed_x, F, 0.50, 0, 1) X(speed_y, F, 0.74, 0, 1) X(speed_size, F, 3.0, 1.0, 8.0) \
  X(speed_alpha, F, 1.0, 0.05, 1) X(speed_bg_alpha, F, 0.75, 0.0, 1) X(speed_col, I, 0xEBEBF5, 0, 0xFFFFFF) X(speed_bg, I, 1, 0, 1) \
  X(elytra_on,    I, 1,    0, 1) X(elytra_x, F, 0.50, 0, 1) X(elytra_y, F, 0.56, 0, 1) X(elytra_size, F, 3.0, 1.0, 8.0) X(elytra_style, I, 0, 0, 2) \
  X(elytra_angle_on, I, 0, 0, 1) X(elytra_angle_x, F, 0.50, 0, 1) X(elytra_angle_y, F, 0.62, 0, 1) X(elytra_angle_size, F, 3.0, 1.0, 8.0) X(elytra_angle_alpha, F, 1.0, 0.05, 1) X(elytra_angle_bg_alpha, F, 0.75, 0.0, 1) X(elytra_angle_col, I, 0xEBEBF5, 0, 0xFFFFFF) X(elytra_angle_bg, I, 1, 0, 1) \
  X(elytra_alpha, F, 1.0, 0.05, 1) X(elytra_bg_alpha, F, 0.75, 0.0, 1) X(elytra_col, I, 0xAA8CFF, 0, 0xFFFFFF) \
  X(nohurt,       I, 0,    0, 1) \
  ...
  X(ui_font,      I, 0,    0, 6) \
  X(n_x,          F, 0.92, 0, 1) X(n_y, F, 0.80, 0, 1) X(n_btn, F, 3.0, 1.0, 8.0) X(n_alpha, F, 1.0, 0.0, 1) X(n_text_alpha, F, 1.0, 0.0, 1) \
